...
| restricted payoff matrix + pureDuality | B2 rung resolves every priced plan × every witness; rows reduced to min on the spot | search 05 §2.4½, search 09 §7 | **discarded** (retention = one number/cell, zero extra resolutions) | SET (drill) |
