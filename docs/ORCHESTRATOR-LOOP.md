...
| p3-e (CC) | sonnet | PLAN-3 item 7 leftovers: four dead exports in turn-oracle, staging-legality, substrate | tsc, eslint, named suites |
| p3-d (CC) | sonnet | PLAN-3 item 9 (climb covers the pair and the polish; core.ts only) | byte-identical runner; core.test; lens determinism |
