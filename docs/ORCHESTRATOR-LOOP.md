...
## Active wave (update on every launch/merge) — 2026-09-04 19:24Z
...
| p3-c (CC) | sonnet | PLAN-3 items 4, 8, 5 (4 and 8 committed at 19:18Z) | byte-identical runner between items; soundness sweep; named suites |
