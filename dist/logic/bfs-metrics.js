...
exports.MultiHeadMetricsBFS = void 0;
class MultiHeadMetricsBFS {
    constructor() {
        this.FOOD_BONUS = 10;
    }
    /**
     ...
     */
    computeMetrics(board, aliveSnakes) {
        ...
        const snakeByIndex = new Map();
        const snakeFoodDistances = new Map();
        ...
        while (currentLevel.length > 0) {
            const nextLevel = [];
            const levelClaims = new Map(); // pos -> list of claims
        ...
        return this.calculateMetrics(board, aliveSnakes, owners, snakeFoodDistances, snakeIndexMap, width, height);
    }
    /**
     * Calculate final metrics from computed data
     */
    calculateMetrics(board, snakes, owners, snakeFoodDistances, snakeIndexMap, width, height) {
        const perSnakeMetrics = new Map();
